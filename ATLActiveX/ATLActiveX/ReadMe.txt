...
应用程序向导已为您创建了此 ATLActiveX 项目，作为编写动态链接库 (DLL) 
的起点。
...
ATLActiveX.idl
    ...
    此文件将由 MIDL 编译器处理以生成：
        ...
        类型库				(ATLActiveX.tlb)
        封送处理代码			(ATLActiveX_p.c 和 
                                           dlldata.c）

ATLActiveX.h
    此文件包含 ATLActiveX.idl 中定义的项目的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 ATLActiveX.pch 的预编译头 (PCH) 文件和
