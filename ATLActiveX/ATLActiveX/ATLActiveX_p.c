...
typedef struct _ATLActiveX_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } ATLActiveX_MIDL_TYPE_FORMAT_STRING;

typedef struct _ATLActiveX_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } ATLActiveX_MIDL_PROC_FORMAT_STRING;

typedef struct _ATLActiveX_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } ATLActiveX_MIDL_EXPR_FORMAT_STRING;
...
extern const ATLActiveX_MIDL_TYPE_FORMAT_STRING ATLActiveX__MIDL_TypeFormatString;
extern const ATLActiveX_MIDL_PROC_FORMAT_STRING ATLActiveX__MIDL_ProcFormatString;
extern const ATLActiveX_MIDL_EXPR_FORMAT_STRING ATLActiveX__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IIEControl_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IIEControl_ProxyInfo;
...
static const ATLActiveX_MIDL_PROC_FORMAT_STRING ATLActiveX__MIDL_ProcFormatString =
    {
        0,
        {
...
static const ATLActiveX_MIDL_TYPE_FORMAT_STRING ATLActiveX__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    ATLActiveX__MIDL_ProcFormatString.Format,
...
/* Object interface: IIEControl, ver. 0.0,
   GUID={0xB222902F,0x02B5,0x48F8,{0x81,0x7F,0xF5,0x89,0xB5,0xE1,0x7A,0x2C}} */

#pragma code_seg(".orpc")
static const unsigned short IIEControl_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IIEControl_ProxyInfo =
    {
    &Object_StubDesc,
    ATLActiveX__MIDL_ProcFormatString.Format,
    &IIEControl_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IIEControl_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    ATLActiveX__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IIEControlProxyVtbl = 
{
    &IIEControl_ProxyInfo,
    &IID_IIEControl,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IIEControl::test */
};


static const PRPC_STUB_FUNCTION IIEControl_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IIEControlStubVtbl =
{
    &IID_IIEControl,
    &IIEControl_ServerInfo,
    8,
    &IIEControl_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    ATLActiveX__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _ATLActiveX_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IIEControlProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _ATLActiveX_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IIEControlStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _ATLActiveX_InterfaceNamesList[] = 
{
    "IIEControl",
    "IComponentRegistrar",
    0
...
const IID *  const _ATLActiveX_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _ATLActiveX_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _ATLActiveX, pIID, n)

int __stdcall _ATLActiveX_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _ATLActiveX, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _ATLActiveX, 2, *pIndex )
    
}

const ExtendedProxyFileInfo ATLActiveX_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _ATLActiveX_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _ATLActiveX_StubVtblList,
    (const PCInterfaceName * ) & _ATLActiveX_InterfaceNamesList,
    (const IID ** ) & _ATLActiveX_BaseIIDList,
    & _ATLActiveX_IID_Lookup, 
    2,
    2,
